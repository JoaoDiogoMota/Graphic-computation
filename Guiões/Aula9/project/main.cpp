...
void prepareCilinder(float height, float radius, int sides) {
	...
	for (int i = 0; i < sides; ++i) {
		...
		normalB[vertex * 3 + 0] = radius * sin((i + 1) * delta);
		normalB[vertex * 3 + 1] = 0.0f;
		normalB[vertex * 3 + 2] = radius * cos((i + 1) * delta);
		...
		normalB[vertex * 3 + 0] = radius * sin(i * delta);
		normalB[vertex * 3 + 1] = 0.0f;
		normalB[vertex * 3 + 2] = radius * cos(i * delta);
